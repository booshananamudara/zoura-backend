...
const vendor_auth_controller_1 = require("./vendor-auth.controller");
...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            jwt_1.JwtModule.registerAsync({
                ...
                useFactory: async (configService) => ({
                    secret: configService.get('JWT_SECRET') || 'your-secret-key-change-this-in-production',
                    signOptions: {
        ...
        exports: [auth_service_1.AuthService, vendor_auth_service_1.VendorAuthService, admin_auth_service_1.AdminAuthService, vendors_service_1.VendorsService],
    })
], AuthModule);
